...
router.post("/doctor/profile",auth,async(req,res,next)=>{
    try {
       const {date} =req.body
...
router.post("/patient/document",upload.single("file"),async(req,res,next)=>{
    try {
...
router.post("/patient/doc",auth,async(req,res,next)=>{
    try {
        const userId=req.user.id
...
router.post("/patient/data",auth,async(req,res,next)=>{
    try {
        const userId=req.user.id
